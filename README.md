We plan to implement a DevSecOps CI/CD pipeline for a Netflix clone deployment. Our approach involves utilizing Jenkins as our CI/CD tool, monitoring the Ubuntu server with Grafana and Prometheus, and integrating email notifications for pipeline confirmation.
...
- Clone your application's code repository onto the EC2 instance:
    ...
    ```bash
    git clone https://github.com/Loopjoke82/Deploy-Netflix-Clone-on-Kubernetes
    ```
...
pipeline {
    ...
    stages {
        ...
        stage('Checkout from Git') {
            steps {
                git branch: 'main', url: 'https://github.com/Loopjoke82/Deploy-Netflix-Clone-on-Kubernetes.git'
            }
        }
